...
./multiplyer Res 0.25 A B C D
    Перед проведением операции умножения необходимо с каталогом с файлами создать путь /catalogue (в нём обязаны храниться все матрицы в соответствующих расширениях, в нём будут храниться все результаты программ).
